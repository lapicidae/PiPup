        ...
        thread {
            try {
                ...
                if (connection.responseCode == 200) {
                    ...
                    val releases: List<GitHubRelease> = mapper.readValue(json, object : TypeReference<List<GitHubRelease>>() {})
                    ...
                    if (latest != null) {
                        ...
                        // We do NOT call onNoUpdate here. This avoids clearing a potentially existing "Beta" tag
                        // when a background "Stable" check finds nothing.
                    }
                } else {
